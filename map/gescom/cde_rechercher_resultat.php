            ...
            switch ($_POST['typeRech']) {
                ...
                case "num" :
                    ...
                    if (is_object($cde)) {
                        ...
                        $TVA = $totalGeneral*0.2;
                        echo "<tr><td colspan='4' align='right'>Total TVA</td><td align='right'>".round(($TVA) * 100)/100 ." €</td>";
                        $TTC = $totalGeneral*1.2;
                        echo "<tr><td colspan='4' align='right'><b>TOTAL TTC</b></td><td align='right'><b>".round(($TTC) * 100)/100 ." €</b></td>";
                        echo "</table></p>";
                ...
                case "cli" :
                    ...
                    $tabClis = $cliManager->getList("WHERE nomClient=\"".$nom."\";");
